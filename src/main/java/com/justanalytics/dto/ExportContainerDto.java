...
@JsonPropertyOrder({"unique_key", "operator_id", "complex_id", "facility_id", "visit_state", "container_nbr", "equipment_type",
        ...
        "requires_xray", "custom_tag", "ib_appointment_start_date", "ib_appointment_end_date", "ob_appointment_start_date", "ob_appointment_end_date", "shipper", "consignee", "show_tvarrival_status", "tv_arrival_status", "tv_arrival_remarks", "house_bls",
