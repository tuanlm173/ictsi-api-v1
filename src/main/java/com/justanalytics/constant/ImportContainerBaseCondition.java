...
public final class ImportContainerBaseCondition {
    ...
    public static final String IMPORT_CONTAINER_BASE_QUERY = "SELECT TOP %s c.UniqueKey,\n" +
            "c.OperatorID,\n" +
            "c.ComplexID,\n" +
            "c.FacilityID,\n" +
            "c.visit_state,\n" +
    ...
    public static final String IMPORT_CONTAINER_FREIGHT_KIND = "(c.freight_kind = '%s' AND IS_DEFINED(c.freight_kind))";
    public static final String IMPORT_CONTAINER_VISIT_STATE = "(c.visit_state = '%s' AND IS_DEFINED(c.visit_state))";
    public static final String IMPORT_CONTAINER_TRANSIT_STATE = "(c.transit_state = '%s' AND IS_DEFINED(c.transit_state))";
    public static final String IMPORT_CONTAINER_ISO_GROUP = "(c.iso_group = '%s' AND IS_DEFINED(c.iso_group))";
    public static final String IMPORT_CONTAINER_ARRIVE_POS_LOCTYPE = "(c.arrive_pos_loctype = '%s' AND IS_DEFINED(c.arrive_pos_loctype))";
    public static final String IMPORT_CONTAINER_DEPART_POST_LOCTYPE = "((c.visit_state = '3DEPARTED' AND IS_DEFINED(c.visit_state)) AND (c.last_pos_loctype = '%s' AND IS_DEFINED(c.last_pos_loctype)))";
    public static final String IMPORT_CONTAINER_DEPART_POST_LOC_ID = "((c.visit_state = '3DEPARTED' AND IS_DEFINED(c.visit_state)) AND (c.last_pos_locid = '%s' AND IS_DEFINED(c.last_pos_locid)))";
    public static final String IMPORT_CONTAINER_ARRIVE_POS_LOC_ID = "(c.arrive_Pos_Locid = '%s' AND IS_DEFINED(c.arrive_Pos_Locid))";
    public static final String IMPORT_CONTAINER_NUMBER = "(c.ContainerNbr = '%s' AND IS_DEFINED(c.ContainerNbr))";
    public static final String IMPORT_CONTAINER_EQUIPMENT_TYPE = "(c.EquipmentType = '%s' AND IS_DEFINED(c.EquipmentType))";
    public static final String IMPORT_CONTAINER_OPERATION_LINE_ID = "(c.OperatorLineID = '%s' AND IS_DEFINED(c.OperatorLineID))";
    ...
    public static final String IMPORT_CONTAINER_BOOKING_NUMBER = "(c.BookingNumber = '%s' AND IS_DEFINED(c.BookingNumber))";
